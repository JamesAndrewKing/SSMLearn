function [data_projected, P_min, V_trunc_slow,data_non_projected,data_non_projected_trunc,lambda_trunc] = obliqueProjection_fullPhaseSpace(data,index_proj,SSMDim, overEmbed, ShiftStep, varargin)
